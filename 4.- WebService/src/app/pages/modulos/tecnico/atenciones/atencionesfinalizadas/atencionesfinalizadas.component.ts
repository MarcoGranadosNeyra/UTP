...
@Component({
  selector: 'app-atencionesfinalizadas',
  templateUrl: './atencionesfinalizadas.component.html',
  styleUrls: ['./atencionesfinalizadas.component.css']
})
export class AtencionesfinalizadasComponent implements OnInit {
  ...
  listarAtenciones(id_usuario:number) {
      this.atencionService.listarAtencionesFinalizadas(id_usuario)
      .subscribe(res => {
