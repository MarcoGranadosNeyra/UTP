...
@Component({
  selector: 'app-cotizacionesaprobadas',
  templateUrl: './cotizacionesaprobadas.component.html',
  styleUrls: ['./cotizacionesaprobadas.component.css']
})
export class CotizacionesaprobadasComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listarCotizacionesAprobadas();
    
  }

  listarCotizacionesAprobadas() {
    this.cotizacionService.listarCotizacionesAprobadas()
    .subscribe(res => {     
      this.dataArray = res;
