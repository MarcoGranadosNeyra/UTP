...
@Component({
  selector: 'app-listentregados',
  templateUrl: './listentregados.component.html',
  styleUrls: ['./listentregados.component.css']
})
export class ListentregadosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listarEquiposEntregados();
  }

  listarEquiposEntregados() {
      this.recepcionService.listarEquiposEntregados()
      .subscribe(res => {
        this.dataArray = res;
