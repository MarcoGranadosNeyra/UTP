...
@Component({
  selector: 'app-listrecepcion',
  templateUrl: './listrecepcion.component.html',
  styleUrls: ['./listrecepcion.component.css']
})
export class ListrecepcionComponent implements OnInit {
